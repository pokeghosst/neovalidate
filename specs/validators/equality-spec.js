describe('validators.equality', function () {
  let equality = validate.validators.equality
  ...
  it('allows you to customize the error message', function () {
    ...
    const options = { attribute: 'bar', message: 'some other message %{attribute}' }
  ...
  it('supports default options', function () {
    ...
    const options = { message: 'foobar', attribute: 'baz' }
  ...
  it('accepts an optional comparator', function () {
    ...
    const other = { bar: 'foo' }
    const comparator = jasmine.createSpy('comparator').and.returnValue(true)
    const attributes = { complex, other }
    const constraints = {
      complex: {
        equality: {
          attribute: 'other',

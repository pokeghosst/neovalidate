describe('validators.numericality', function () {
  const numericality = validate.validators.numericality
    .bind(validate.validators.numericality)

  afterEach(function () {
    const n = validate.validators.numericality
    delete n.message
    delete n.notValid
    delete n.notInteger
    delete n.notOdd
  ...
  describe('onlyInteger', function () {
    ...
    it('uses the custom message if specified', function () {
      const opts = { onlyInteger: true, notInteger: 'default message' }
      expect(numericality(3.14, opts)).toEqual('default message')
    })
  })
  ...
  it('calls custom prettify from options', function () {
    const options = { greaterThan: 0, prettify: function () {} }

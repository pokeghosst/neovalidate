describe('validators.url', function () {
  let url = validate.validators.url
  url = url.bind(url)
  ...
  it("doesn't allow 'invalid' urls", function () {
    const expected = 'is not a valid url'
  ...
  it('allows you to customize the error message', function () {
    ...
    const options = { message: 'is not an url dude' }
  ...
  it('supports default options', function () {
    ...
    const options = { message: 'foobar', allowLocal: true, schemes: ['myscheme'] }
